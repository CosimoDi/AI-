...
# ============================================
# APP ID
APP_ID = "cli_a9f60adc4a389bcd" # 在这里填写你的APP_ID

# APP Secret
APP_SECRET = "Mu3XctOmqrhSGVOG9RBeCcPBfYwmMGim" # 在这里填写你的APP_SECRET
...
# 群聊ID（当发送给群聊时）
CHAT_ID = "oc_e205b5ceb3ca73b845668f940680c536" # 在这里填写你的CHAT_ID
